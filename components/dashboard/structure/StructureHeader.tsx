// components/dashboard/structure/StructureHeader.tsx
"use client";
...
export default function StructureHeader() {
  ...
  return (
    <div className="relative overflow-hidden rounded-t-2xl bg-gradient-to-r from-red-600 via-red-500 to-red-600 px-8 pt-8 pb-6">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-sm text-white/80 mt-1">
                Kelola struktur organisasi pemerintah desa
              </p>
            </div>
          </div>
