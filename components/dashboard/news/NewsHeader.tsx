// components/dashboard/news/NewsHeader.tsx
"use client";
...
export default function NewsHeader() {
  ...
  // FIX: Pakai ||| (nullish coalescing) biar tidak falsy
  ...
  return (
    <div className="relative overflow-hidden rounded-t-2xl bg-gradient-to-r from-blue-600 via-blue-500 to-indigo-600 px-8 pt-8 pb-6">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-sm text-white/80 mt-1">
                Kelola berita, pengumuman, dan event desa
              </p>
            </div>
          </div>
