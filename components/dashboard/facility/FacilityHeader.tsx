// components/dashboard/facility/FacilityHeader.tsx
"use client";
...
export default function FacilityHeader() {
  ...
  const isFormMode = searchParams.get("add") || searchParams.get("edit");
  ...
  return (
    <div className="relative overflow-hidden rounded-t-2xl bg-gradient-to-r from-violet-600 via-purple-500 to-fuchsia-600 px-8 pt-8 pb-6">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <p className="text-sm text-white/80 mt-1">
                Kelola fasilitas pendidikan, ibadah, kesehatan, dan ekonomi
              </p>
            </div>
          </div>
