...
export default function StorePage() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50">
        <div className="relative mb-4">
          ...
          <FaSpinner
            className="animate-spin text-emerald-600 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
            size={24}
          />
        </div>
  ...
  const totalProduk = stores.reduce(
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20 font-sans">
      ...
      <div
        ...
        style={{
          backgroundImage: "url(/img/store.png)",
      ...
      <div className="container mx-auto px-4 md:px-12 -mt-10 relative z-20">
        {/* TAB */}
        <div className="bg-white rounded-full p-1.5 shadow-lg border border-slate-100 inline-flex mb-6 w-full md:w-auto mx-auto md:mx-0">
          <button
            ...
            stores.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-24 bg-white rounded-3xl border border-dashed border-slate-200">
                ...
                <p className="text-slate-500 text-center max-w-sm">
                  Sepertinya produk belum tersedia nih. Silakan datang kembali.
                </p>
              </div>
            ) : (
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 md:gap-8">
                {stores.map((store) =>
                  store.products
                    ...
                    .sort((a, b) => {
                      if (sort === "harga_asc") return a.price - b.price;
                      if (sort === "harga_desc") return b.price - a.price;
                      return 0;
                    })
                    .map((product) => (
                      <ProductCard
