  ...
  return (
    <main className="min-h-screen relative overflow-hidden bg-gradient-to-b from-emerald-50 via-white to-green-50">
      ...
      <section className="relative py-24 text-center px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 text-emerald-700 text-sm font-medium shadow-sm">
            <Sparkles className="w-4 h-4" />
            Smart Village System
          </div>

          <h1 className="mt-6 text-4xl md:text-6xl font-extrabold text-slate-800">
            SIKADES CERDAS
          </h1>

          <p className="mt-4 text-slate-600 text-lg">
            Sistem Informasi Desa modern untuk digitalisasi data, pelayanan, dan transparansi publik
          </p>

          <div className="mt-6 text-sm text-emerald-700 font-medium">
      ...
      <section className="max-w-6xl mx-auto px-6 py-10">
        <motion.div
          ...
          className="bg-gradient-to-r from-emerald-600 to-green-500 text-white rounded-3xl p-8 shadow-xl"
        >
      ...
      <section className="max-w-6xl mx-auto px-6 py-10">
        ...
        >
          ...
          <div className="flex items-center gap-3 text-slate-700">
            ...
            <span>SIKADES Cerdas UMP Development Team</span>
          </div>

          <div className="flex items-center gap-3 text-slate-700 mt-2">
            <MapPin className="text-emerald-600" />
            <span>Universitas Muhammadiyah Purwokerto (UMP)</span>
          </div>
      ...
      <section className="py-16 text-center">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          className="inline-block px-8 py-3 rounded-full bg-emerald-600 text-white font-semibold shadow-xl"
        >
